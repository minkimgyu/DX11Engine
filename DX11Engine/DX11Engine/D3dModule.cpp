...
D3dModule::D3dModule(const D3dModule& other)
{
}
...
bool D3dModule::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
...
ID3D11Device* D3dModule::GetDevice()
{
	return _device;
}


ID3D11DeviceContext* D3dModule::GetDeviceContext()
{
	return _deviceContext;
}


void D3dModule::GetProjectionMatrix(XMMATRIX& projectionMatrix)
{
...
void D3dModule::GetWorldMatrix(XMMATRIX& worldMatrix)
{
...
void D3dModule::GetOrthoMatrix(XMMATRIX& orthoMatrix)
{
...
void D3dModule::GetVideoCardInfo(char* cardName, int& memory)
{
